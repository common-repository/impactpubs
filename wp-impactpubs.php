...
function impactpubs_settings_form() {
	...
	<div class = "wrap">
		...
		<form method = "POST" id = "impactpubsForm">
			...
			<table>
				<input type="hidden" name="impactpubs_pubsource" value="pubmed" id="impactpubs_pubsource_pubmed" />
            ...
            <input type="text" name="impactpubs_identifier" id="impactpubs_identifier"
					...
					<td><i>Enter a unique query string (e.g. Ydenberg CA AND (Brandeis[affiliation] OR Princeton[affiliation]).<br /></i></td>
				</tr>
